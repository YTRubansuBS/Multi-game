...
const scripts=['rooms.js','authfix.js','sessionfix.js','adminfix.js','crownfix.js','chatfix.js','cards300.js','crownrift_master.js','packbattlefix.js','crown_final_ui.js','crown_navfix.js'];
...
console.log('CROWN RIFT FINAL UI BUILD OK');

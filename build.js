...
const scripts=['rooms.js','gamepatch.js','authfix.js','roomfix.js','adminfix.js','crownfix.js','chatfix.js','cards300.js'];
for(const file of scripts){if(!html.includes(file))html=html.replace('</body>',`<script src="/${file}"></script></body>`)}
// Make the Supabase client created by index.html available to the compatibility patches.
